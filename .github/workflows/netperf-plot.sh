...
plot \
   ...
   '${OUTPUT}/out/um-nommu-seccomp-netperf-fwd-out.dat' usin (\$0*2+0.3):(\$2/1000) w boxes $PAT_NOMMU_S title "um(nommu(s))" ,\
   ...
   '${OUTPUT}/out/um-nommu-seccomp-netperf-rev-out.dat' usin (\$0*2+0.3):(\$2*-1/1000) w boxes $PAT_NOMMU_S notitle ,\
